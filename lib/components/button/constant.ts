export const BUTTON_VARIANT = {
  default:
    "border border-(--color-primary) text-(--color-primary) hover:bg-gray-100",
  primary:
    "bg-(--color-primary) text-white hover:bg-(--color-primary-400) focus:ring-1",
  filled:
    "bg-(--color-primary-100) text-(--color-primary) hover:bg-(--color-primary-200)",
